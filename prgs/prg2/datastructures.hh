...
public:
    ...
    // Estimate of performance: O(V+E) + (O(n) from trace_route)
    // Short rationale for estimate: BFS (for trace_route vector + reverse is same as using list and turning it into vector)
